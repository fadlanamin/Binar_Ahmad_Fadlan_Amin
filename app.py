...
swagger_template = {
    "info": {
        "title": LazyString(lambda: "Data Cleansing API"),
        "version": LazyString(lambda: "1.0.0"),
        "description": LazyString(lambda: "Binar Gold Challenge : Data Cleansing API")
    },
...
def home():
    welcome_msg = {
        "version": "1.0.0",
        "message": "Binar Gold Challenge : Flask API",
        "author": "Ahmad Fadlan Amin - Wave 9"
    }
